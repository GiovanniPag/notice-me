...
import { SECONDARY_PLACEHOLDER, PLACEHOLDER, APP_THEME } from 'app/config/tag-chips.constants';
...
function matchingFn(this: TagInputDropdown, value: string, target: TagModel): boolean {
  ...
  return (targetValue && targetValue.toLowerCase().indexOf(value.toLowerCase()) >= 0) as boolean;
}
