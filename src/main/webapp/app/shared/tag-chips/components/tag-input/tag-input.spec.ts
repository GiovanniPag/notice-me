...
describe('TagInputComponent', () => {
  ...
  describe('when using the autocomplete', () => {
    ...
    it('does not let add item if onlyFromAutocomplete is set to true', () => {
      const fixture: ComponentFixture<TagInputComponentWithOnlyAutocomplete> = TestBed.createComponent(
        TagInputComponentWithOnlyAutocomplete
      );
  ...
  describe('model as strings', () => {
    it('adds item to the model as a string', fakeAsync(() => {
      const fixture: ComponentFixture<TagInputComponentWithModelAsStrings> = TestBed.createComponent(TagInputComponentWithModelAsStrings);
  ...
  describe('when addOnBlur is true', () => {
    it('should add an item on blur', fakeAsync(() => {
      const fixture: ComponentFixture<TagInputComponentWithAddOnBlur> = TestBed.createComponent(TagInputComponentWithAddOnBlur);
  ...
  describe('when editing an editable tag', () => {
    ...
    it('does not switch tags upon arrow or backspace keydown events', fakeAsync(() => {
      ...
      component.tags.first.onKeyDown.subscribe(event => fail('Key event: ' + event.event.keyCode + ' passed to tag-input'));
