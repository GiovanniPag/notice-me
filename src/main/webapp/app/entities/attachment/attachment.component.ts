...
export class AttachmentComponent implements OnInit, OnDestroy {
  ...
  loadAll(): void {
    this.attachmentService
      ...
      .subscribe((res: HttpResponse<IAttachment[]>) => this.paginateAttachments(res.body, res.headers));
  }
  ...
  registerChangeInAttachments(): void {
    this.eventSubscriber = this.eventManager.subscribe('attachmentListModification', () => this.reset());
  }
  ...
  protected paginateAttachments(data: IAttachment[] | null, headers: HttpHeaders): void {
