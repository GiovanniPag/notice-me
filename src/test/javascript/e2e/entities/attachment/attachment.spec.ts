...
describe('Attachment e2e test', () => {
  ...
  it('should load Attachments', async () => {
    ...
    expect(await attachmentComponentsPage.getTitle()).to.eq('noticeMeApp.attachment.home.title');
  ...
  it('should load create Attachment page', async () => {
    ...
    expect(await attachmentUpdatePage.getPageTitle()).to.eq('noticeMeApp.attachment.home.createOrEditLabel');
  ...
  it('should create and save Attachments', async () => {
    ...
    expect(await attachmentUpdatePage.getDataInput()).to.endsWith(
      fileNameToUpload,
      'Expected Data value to be end with ' + fileNameToUpload
    );
