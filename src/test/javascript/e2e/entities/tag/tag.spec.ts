...
describe('Tag e2e test', () => {
  ...
  it('should load Tags', async () => {
    ...
    expect(await tagComponentsPage.getTitle()).to.eq('noticeMeApp.tag.home.title');
  ...
  it('should load create Tag page', async () => {
    ...
    expect(await tagUpdatePage.getPageTitle()).to.eq('noticeMeApp.tag.home.createOrEditLabel');
  ...
  /* it('should create and save Tags', async () => {
        ...
        await promise.all([
            ...
            tagUpdatePage.ownerSelectLastOption(),
        ]);
  ...
  /* it('should delete last Tag', async () => {
        ...
        expect(await tagDeleteDialog.getDialogTitle())
            .to.eq('noticeMeApp.tag.delete.question');
